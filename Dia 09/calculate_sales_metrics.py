...
print(f"Mediana das vendas: R$ {median_sales:.2f}")
print(f"Desvio padrão das vendas: R$ {standard_deviation_on_sales:.2f}")
print(f"Maior valor de venda: R$ {max_sales:.2f}")
print(f"Menor valor de venda: R$ {min_sales:.2f}")
