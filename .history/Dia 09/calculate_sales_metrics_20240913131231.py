...
mean_sales = np.mean(sales_df)
median_sales = np.median(sales_df)
standard_deviation_on_sales = np.std(sales_df)
max_sales = np.max(sales_df)
min_sales = np.min(sales_df)
