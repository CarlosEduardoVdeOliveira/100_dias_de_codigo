...
mean_sales = "{:.2f}".format(np.mean(sales_df))
median_sales = "{:.2f}".format(np.median(sales_df))
standard_deviation_on_sales = "{:.2f}".format(np.std(sales_df, ddof=1))
max_sales = "{:.2f}".format(np.max(sales_df))
min_sales = "{:.2f}".format(np.min(sales_df))
