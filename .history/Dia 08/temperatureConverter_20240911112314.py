def temperature_converet_celsius_to_fahrenheit(temperature):
  return "Conversão de °C para °F" + "{:.2f}".format(temperature * 1.8 + 32) + " °F"

def temperature_converet_fahrenheit_to_celsius(temperature):
  return "Conversão: °F para °C" + "{:.2f}".format((temperature - 32 ) * (5 / 9)) + " °C"

def temperature_converet_celsius_to_kelvin(temperature):
  return "Conversão: °C para °K" + "{:.2f}".format(temperature + 273.15) + " °K"

def temperature_converet_kelvin_to_celsius(temperature):
  return "Conversão: °K para °C" + "{:.2f}".format(temperature - 273.15) + " °C"

def temperature_converet_fahrenheit_to_kelvin(temperature):
  return "Conversão: °F para °F" + "{:.2f}".format((temperature - 32) * (5 / 9) + 273.15) + " °K"

def temperature_converet_kelvin_to_fahrenheit(temperature):
  return "Conversão: °F para °F" + "{:.2f}".format((temperature - 273.15) * (9 / 5) + 32) + " °F"
