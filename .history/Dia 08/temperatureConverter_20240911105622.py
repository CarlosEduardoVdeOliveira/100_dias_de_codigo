...
switch ={
  1: temperature_converet_celsius_to_fahrenheit(te),
  2: temperature_converet_fahrenheit_to_celsius(te),
  3: temperature_converet_celsius_to_kelvin(te),
  4: temperature_converet_kelvin_to_celsius(te),
  5: temperature_converet_fahrenheit_to_kelvin(te),
  6: temperature_converet_kelvin_to_fahrenheit(te),
}