...
print("=========Menu===========")
print("Opção 1: celsius_to_fahrenheit(temperature), ")
print("Opção   2: fahrenheit_to_celsius(temperature), ")
print("Opção   3: celsius_to_kelvin(temperature), ")
print("Opção   4: kelvin_to_celsius(temperature), ")
print("Opção   5: fahrenheit_to_kelvin(temperature), ")
print("Opção   6: kelvin_to_fahrenheit ")
