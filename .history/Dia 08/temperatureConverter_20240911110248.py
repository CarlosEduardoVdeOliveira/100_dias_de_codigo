...
print("=========Menu===========")
print("Opção 1: celsius fahrenheit(temperature), ")
print("Opção   2: fahrenheit celsius(temperature), ")
print("Opção   3: celsius kelvin(temperature), ")
print("Opção   4: kelvin celsius(temperature), ")
print("Opção   5: fahrenheit kelvin(temperature), ")
print("Opção   6: kelvin fahrenheit ")
