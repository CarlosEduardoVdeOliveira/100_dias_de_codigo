...
print("=========Menu===========")
print("Opção 1: temperature_converet_celsius_to_fahrenheit(temperature), ")
print("Opção   2: temperature_converet_fahrenheit_to_celsius(temperature), ")
print("Opção   3: temperature_converet_celsius_to_kelvin(temperature), ")
print("Opção   4: temperature_converet_kelvin_to_celsius(temperature), ")
print("Opção   5: temperature_converet_fahrenheit_to_kelvin(temperature), ")
print("Opção   6: temperature_converet_kelvin_to_fahrenheit ")
